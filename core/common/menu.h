    ...
    while(!jogar){
        ...
        switch(opcao){
            ...
            case 4: //JOGAR
                ...
                al_draw_bitmap_region(spritePersonagem, regiaoxPerso,regiaoyPerso, larguraPerso,alturaPerso, pacoteCliente.posxPerso,pacoteCliente.posyPerso,0);
                al_flip_display();
                ...
                while(!sair){   
                    ...
                    while(!al_is_event_queue_empty(filaEventos)){
                        ALLEGRO_EVENT evento;
                        //recebe evento da tecla precionada "pacoteCliente.tecla"
                            ...
                            if(evento.type == ALLEGRO_EVENT_KEY_DOWN){ 
                                switch(evento.keyboard.keycode){ 
                                    ...
                                    case ALLEGRO_KEY_A : // TECLA A
                                        pacoteCliente.posxPerso -= 30; // server
                                        tecla = 3;
                                        break;
                    ...
                    if(1){
                        if((pacoteCliente.posyPerso>=365 && (pacoteCliente.posxPerso<20 || pacoteCliente.posxPerso>=830)) || (pacoteCliente.posxPerso>=830) || (pacoteCliente.posyPerso>365 && pacoteCliente.posxPerso<420)|| (pacoteCliente.posyPerso>265 && pacoteCliente.posxPerso>=450)){ // CAI // SERVIDOR
                            pacoteCliente.posyPerso = cair (tecla, inverte, regiaoxPerso, regiaoyPerso, larguraPerso, alturaPerso, pacoteCliente.posxPerso, pacoteCliente.posyPerso, lado);
            
                        } 
                        if(pacoteCliente.posxPerso>385 && pacoteCliente.posxPerso<430 && pacoteCliente.posyPerso == 365){ // PORTAL DEBAIXO // SERVIDOR
                            pacoteCliente.posxPerso = 465;
                            pacoteCliente.posyPerso = 265;
                        }
                        if(pacoteCliente.posxPerso>=420 && pacoteCliente.posxPerso<460 && pacoteCliente.posyPerso == 265){ // PORTAL DE CIMA // SERVIDOR
                            pacoteCliente.posxPerso = 380;
                            pacoteCliente.posyPerso = 365;
                        }
                        if(pacoteCliente.posyPerso>600){ // RESSURGIR // SERVIDOR
                            if(contador%2==0){
                                pacoteCliente.posyPerso = 265;
                                pacoteCliente.posxPerso = resurgir(contador);
                            }else{
                                pacoteCliente.posyPerso = 365;
                                pacoteCliente.posxPerso = resurgir(contador);
                            }
                        ...
                        printf("%d %d\n", pacoteCliente.posxPerso, pacoteCliente.posyPerso);
                        if(noAr == 1 && cont==3){ //CAI DO PULO
                            pacoteCliente.posyPerso = pulaDesce(tecla, inverte, regiaoxPerso, regiaoyPerso, larguraPerso, alturaPerso, pacoteCliente.posxPerso, pacoteCliente.posyPerso);
                            teclaPulo = 0;
                            noAr = 0;
                            cont = 0;
                        }else if(teclaPulo == 1 && noAr == 0){ // PULA 
                            pacoteCliente.posyPerso = pulaSobe(tecla, inverte, regiaoxPerso, regiaoyPerso, larguraPerso, alturaPerso, pacoteCliente.posxPerso, pacoteCliente.posyPerso);
                            teclaPulo = 1;
                            cont ++;
                            if(cont<3){
                                noAr = 0;
                            ...
                            al_draw_bitmap_region(spritePortal, regiaoxPortal2, regiaoyPortal2, larguraPortal,alturaPortal, posxPortal2,posyPortal2,0);
                            al_draw_bitmap_region(spritePortal, regiaoxPortal1, regiaoyPortal1, larguraPortal,alturaPortal, posxPortal1,posyPortal1,0);
                            al_draw_bitmap_region(spritePersonagem, regiaoxPerso, regiaoyPerso, larguraPerso,alturaPerso, pacoteCliente.posxPerso,pacoteCliente.posyPerso,ALLEGRO_FLIP_HORIZONTAL);
                            }
                            al_flip_display();
                            ...
                            pacoteCliente.posxPerso = dash(tecla, inverte, regiaoxPerso, regiaoyPerso, larguraPerso, alturaPerso, pacoteCliente.posxPerso, pacoteCliente.posyPerso,lado);
                            staminaPerso -= 200;
                            tecla = 0;
